...
public class DatabaseAdapter {
    ...
    public List<ModelClass> getAllContacts(){
        ...
        while(cursor.moveToNext()){
            ...
            int image = cursor.getInt(index1);
            ...
            int index4 = cursor.getColumnIndex(DatabaseHelper.KEY_ROWID);
            String id = cursor.getString(index4);
            int index5 = cursor.getColumnIndex(DatabaseHelper.KEY_ROWID);
            String number = cursor.getString(index5);
            int index6 = cursor.getColumnIndex(DatabaseHelper.KEY_ROWID);
            String date = cursor.getString(index6);
            int index7 = cursor.getColumnIndex(DatabaseHelper.KEY_ROWID);
            String prenom = cursor.getString(index5);

            ModelClass contact = new ModelClass(image, name, id,number,date,prenom);
